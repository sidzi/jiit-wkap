...
def buttonbox(msg="", title=" ", choices=("Button[1]", "Button[2]", "Button[3]"), image=None, root=None,
...
def fileopenbox(msg=None, title=None, default='*', filetypes=None, multiple=False):
    ...
    **About the "filetypes" argument**
    ...
    ret_val = func(parent=localRoot, title=getFileDialogTitle(msg, title), initialdir=initialdir,
...
def filesavebox(msg=None, title=None, default="", filetypes=None):
    ...
    f = ut.tk_FileDialog.asksaveasfilename(parent=localRoot, title=getFileDialogTitle(msg, title),
                                           initialfile=initialfile, initialdir=initialdir, filetypes=filetypes
    )
    localRoot.destroy()
    if not f:
        return None
